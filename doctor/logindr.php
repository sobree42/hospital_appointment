...
<center> 
     <h1><center><span class="glyphicon glyphicon-lock"></span> Doctor Login</center></h1>
</center>
  </div>
  <div class="container">
	<div id="login_form" ><hr>
		<form method="POST" action="check-logindr.php">
		Dr.Name : <input type="text" name="username" placeholder="Enter username" class="form-control" required>
