...
//print_r($_POST);
$p_id = $_SESSION['dr_id'];
$sql = 'SELECT descrip.id_treat,doctor.dr_id,patient.user_id,patient.u_name,descrip.treat_for,descrip.treat,descrip.note FROM ((descrip INNER JOIN patient ON descrip.user_id= patient.user_id) INNER JOIN doctor ON descrip.dr_id='.$p_id.' AND doctor.dr_id='.$p_id.') ';
